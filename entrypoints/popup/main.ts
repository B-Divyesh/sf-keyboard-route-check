...
async function verifyLicense(token: string) {
  ...
  try {
    ...
    licenseFeedback = verdict.valid
      ? 'License active. You can save this route to the local report archive.'
