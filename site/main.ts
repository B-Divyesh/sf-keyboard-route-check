...
function footer() {
  return `<footer><p>Record and export manual keyboard routes.</p><nav aria-label="Footer"><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="https://sociobot.in" rel="external">Built by Param Factory (external site)</a></nav><small>v1.0.0 · Generated artwork is original to this product.</small></footer>`;
}
